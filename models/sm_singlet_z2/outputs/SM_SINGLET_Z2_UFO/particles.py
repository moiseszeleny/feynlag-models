...
h = Particle(pdg_code=25, name='h', antiname='h', spin=1, color=1, mass=Param.MH1, width=Param.WH, texname='h', antitexname='h', charge=0, goldstoneboson=False)
...
h2 = Particle(pdg_code=35, name='h2', antiname='h2', spin=1, color=1, mass=Param.MH2, width=Param.WH2, texname='h2', antitexname='h2', charge=0, goldstoneboson=False)
