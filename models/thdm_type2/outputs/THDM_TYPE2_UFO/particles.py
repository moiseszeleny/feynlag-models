...
h = Particle(pdg_code=25, name='h', antiname='h', spin=1, color=1, mass=Param.MH0, width=Param.WH, texname='h', antitexname='h', charge=0, goldstoneboson=False)
...
h2 = Particle(pdg_code=35, name='h2', antiname='h2', spin=1, color=1, mass=Param.MHH, width=Param.WHH, texname='h2', antitexname='h2', charge=0, goldstoneboson=False)

h3 = Particle(pdg_code=36, name='h3', antiname='h3', spin=1, color=1, mass=Param.MA0, width=Param.WA0, texname='h3', antitexname='h3', charge=0, goldstoneboson=False)

h__plus__ = Particle(pdg_code=37, name='h+', antiname='h-', spin=1, color=1, mass=Param.MHp, width=Param.WHp, texname='h+', antitexname='h-', charge=1, goldstoneboson=False)
