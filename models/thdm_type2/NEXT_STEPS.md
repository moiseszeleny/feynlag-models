...
|---|---|---|---|
| $m_{H^\pm}$ lower bound from $B \to X_s\gamma$ (type II, all $\tan\beta$) | TODO(verify) — Misiak & Steinhauser, arXiv:1702.04571 (NNLO) | | TODO(verify) |
| exclusion in the ($\tan\beta$, $m_A$) plane from $A/H \to \tau\tau$ | TODO(verify) — ATLAS/CMS Run-2 searches | ATLAS, CMS | TODO(verify) |
